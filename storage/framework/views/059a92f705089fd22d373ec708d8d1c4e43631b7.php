                    ...
                    <div class="box-body">
                        <div class="col-md-8">
                            <form class="form-horizontal" id="formId"
                                action="<?php echo e(route('customers.update', $customer->id)); ?>" enctype="multipart/form-data" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <img src="<?php echo e(asset($customer->image)); ?>" height="100" width="100" alt="">
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Office Project\dokan\resources\views/customer/edit.blade.php ENDPATH**/ ?>