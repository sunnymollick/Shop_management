                    ...
                    <div class="box-body">
                        <div class="col-md-8">
                            <form class="form-horizontal" id="formId"
                                action="<?php echo e(route('suppliers.update', $supplier->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo e($supplier->name); ?>" id="name" name="name" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo e($supplier->phone); ?>" id="phone" name="phone">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo e($supplier->organization_name); ?>" id="organization_name" name="organization_name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <?php if($errors->has('address')): ?>
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo e($supplier->organization_address); ?>" id="organization_address" name="organization_address">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo e($supplier->trade_license); ?>" id="trade_license" name="trade_license">
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Office Project\dokan\resources\views/supplier/edit.blade.php ENDPATH**/ ?>