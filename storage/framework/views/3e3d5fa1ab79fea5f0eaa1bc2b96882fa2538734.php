                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form class="form-horizontal" action="<?php echo e(route('bundles.update', $bundle->id)); ?>"
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        <?php $__currentLoopData = $bundleProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bundleProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            onImageClick(<?php echo e($bundleProduct->id); ?>, <?php echo e($bundleProduct->unit_price); ?>, "<?php echo e($bundleProduct->title); ?>",
            "<?php echo e($bundleProduct->art_no); ?>",
            <?php echo e($bundleProduct->stock); ?>, <?php echo e($bundleProduct->quantity); ?>);
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        function onImageClick(prodId, unitPrice, title, artNo, stock, prevQuantity = 1) {
            ...
            if (styleValue == '5px solid green') {
                ...
                cell2.innerHTML =
                    ...
                    prevQuantity + '" min="1"  onchange="matchUnitAndSubTotal()"/>';
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cismrdbr/shop.deutschevision.com.bd/resources/views/bundle/edit.blade.php ENDPATH**/ ?>