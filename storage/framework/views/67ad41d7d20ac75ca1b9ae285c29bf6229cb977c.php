    ...
    <section class="invoice">
        ...
        <div class="row">
          <div class="col-xs-12">
            <h2 class="page-header">
              ...
              <small class="pull-right">Date: <?php echo e(date('m/d/Y')); ?></small>
            </h2>
          </div>
          <!-- /.col -->
        </div>
        ...
        <div class="row invoice-info">
          ...
          <div class="col-sm-4 invoice-col">
            ...
            <b>Payment Due:</b> <?php echo e(date_format(date_create($order->return_date),'m/d/Y')); ?><br>
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-xs-6">
            <p class="lead">Amount Due <?php echo e(date_format(date_create($order->return_date),'m/d/Y')); ?></p>
...
<?php /**PATH /home/manvspes/lense.nehal.xyz/resources/views/invoice/show.blade.php ENDPATH**/ ?>