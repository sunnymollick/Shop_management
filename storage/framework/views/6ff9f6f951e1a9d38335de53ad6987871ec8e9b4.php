                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="Lense"
                                                    id="flexCheckDefault" name="category[]" <?php if(strpos($product->category, 'Lense') == true): ?> checked <?php endif; ?>>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="Accessories"
                                                    id="flexCheckChecked" name="category[]" <?php if(strpos($product->category, 'Accessories') == true): ?> checked <?php endif; ?>>
                                                <label class="form-check-label" for="category">
                                                    Accessories
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="Camera"
                                                    id="flexCheckChecked" name="category[]" <?php if(strpos($product->category, 'Camera') == true): ?> checked <?php endif; ?>>
                                                <label class="form-check-label" for="category">
                                                    Camera
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="is_in_service" name="is_in_service">
                                                <option value="1" <?php echo e($product->is_in_service == 1 ? 'selected' : ''); ?>>
                                                    Yes
                                                </option>
                                                <option value="0" <?php echo e($product->is_in_service == 0 ? 'selected' : ''); ?>>No
                                                </option>
                                            </select>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cismrdbr/shop.deutschevision.com.bd/resources/views/product/edit.blade.php ENDPATH**/ ?>