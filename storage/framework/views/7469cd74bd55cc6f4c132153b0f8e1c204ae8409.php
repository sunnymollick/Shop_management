    ...
    <div class="product">
        <div class="thumb" style="background-color: #F7F8FA">
            <a href="<?php echo e(route('product', $product)); ?>" class="image">
                <img src="<?php echo e(env('app_url')); ?><?php echo e(substr($product->image_path, 6)); ?>" alt="Product" height="300px" width="280px" style="object-fit: contain"/>
...
<?php /**PATH D:\xampp\htdocs\dokan\resources\views/ecommerce/components/product-card.blade.php ENDPATH**/ ?>