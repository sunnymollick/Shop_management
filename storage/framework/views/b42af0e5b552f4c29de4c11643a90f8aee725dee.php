            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" action="<?php echo e(route('customers.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>    
...
</html><?php /**PATH G:\All_works\online class\final project\project\laravel\Shop_management\resources\views/customer/signup/registration.blade.php ENDPATH**/ ?>