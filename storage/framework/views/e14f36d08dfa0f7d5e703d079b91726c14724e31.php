...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('public/css/extra.css')); ?>">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(asset('public/images/avatar5.png')); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs">Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo e(asset('public/images/avatar5.png')); ?>" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="<?php echo e(route('my.logout')); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php echo e(Request::is('products*') ? 'active' : ''); ?>">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo e(Request::is('products*') ? 'active' : ''); ?>"><a href="<?php echo e(route('products.index')); ?>"><i class="fa fa-circle-o"></i> All Products </a></li>
              <li class="<?php echo e(Request::is('products/create*') ? 'active' : ''); ?>"><a href="<?php echo e(route('products.create')); ?>"><i class="fa fa-circle-o"></i> Add New Product</a></li>
            </ul>
        </li>
        <li class="treeview <?php echo e(Request::is('customers*') ? 'active' : ''); ?>">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo e(Request::is('customers*') ? 'active' : ''); ?>"><a href="<?php echo e(route('customers.index')); ?>"><i class="fa fa-circle-o"></i> All Customers </a></li>
              <li class="<?php echo e(Request::is('customers/create*') ? 'active' : ''); ?>"><a href="<?php echo e(route('customers.create')); ?>"><i class="fa fa-circle-o"></i> Add New Customer </a></li>
            </ul>
        </li>
        ...
        <li class="treeview <?php echo e(Request::is('orders*') ? 'active' : ''); ?>">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo e(Request::is('orders*') ? 'active' : ''); ?>"><a href="<?php echo e(route('orders.index')); ?>"><i class="fa fa-circle-o"></i> All Orders </a></li>
            </ul>
        </li>
...
<?php /**PATH /home/manvspes/lense.nehal.xyz/resources/views/layouts/app2.blade.php ENDPATH**/ ?>