        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            <form class="form-horizontal" id="formId" action="<?php echo e(route('user.update',$user->id)); ?>"
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\htdocs\dokan\resources\views/settings/edit_user.blade.php ENDPATH**/ ?>